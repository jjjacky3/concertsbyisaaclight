import { Menu, Filter, Upload, LogIn, LogOut, Sun, Moon, Database } from "lucide-react";
        ...
        <>
            ...
            {showTestForm && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
                    <div className="bg-white dark:bg-gray-900 p-6 rounded-lg w-full max-w-5xl max-h-[90vh] overflow-y-auto relative">
                        <button 
